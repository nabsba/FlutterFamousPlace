class AppStylesSpace {
  ...
  static const double extraLargeSpacing = 32.0; // Extra Large size (32px)

  // You can also add text styles, button sizes, etc., if needed
  static const double buttonHeight = 50.0; // Standard button height
}
